 ...
 */
var Callback_Wait=function(a){var t=(new Date).getTime();void 0===a&&(a=250);var n=[];this.add_callback=function(a){n.push({func:a,args:Array.prototype.slice.call(arguments,1)})},this.exe=function(c){if("function"==typeof c){var i=Array.prototype.slice.call(arguments,1);i.unshift(c),this.add_callback.apply(null,i)}var l=(new Date).getTime(),e=Math.max(t+a-l,0);setTimeout(function(){n.forEach(function(a){a.func.apply(null,a.args)})},e)}};